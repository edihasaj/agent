...
description: 'Agent pickup checklist when starting on a task.'
read_when:
...
Source of truth: `docs/slash-commands/pickup.md`. Link runtime-specific command paths to this file.
